...
- **UptimeRobot**: PENDIENTE acción manual del usuario — crear monitor HTTP(S) apuntando a `https://nearme.viajeinteligencia.com/health`, intervalo 5 min, alertas email. No automatizable (requiere cuenta externa).
